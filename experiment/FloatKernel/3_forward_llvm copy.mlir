module attributes {llvm.data_layout = "", torch.debug_module_name = "L"} {
  ...
  llvm.func @forward(%arg0: !llvm.ptr<f32>) -> !llvm.ptr<f32> {
    ...
    %new_54 = llvm.getelementptr %54[1] : (!llvm.ptr<f32>) -> !llvm.ptr<f32>
    %new_55 = llvm.getelementptr %55[2] : (!llvm.ptr<f32>) -> !llvm.ptr<f32>
    llvm.call @forward_kernel_0(%new_54, %new_55) : (!llvm.ptr<f32>, !llvm.ptr<f32>) -> ()
