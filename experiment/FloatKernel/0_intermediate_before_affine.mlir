...
func.func @forward(%arg0: tensor<3x3xf32>) -> tensor<3x3xf32> {
  ...
  %cst = arith.constant dense<[[-0.533737481, 0.0726815313, 0.548144102], [0.339588523, -0.212466493, 0.129553705], [0.423136026, 0.46056211, -0.0355117619]]> : tensor<3x3xf32>
  ...
  %dim = tensor.dim %arg0, %c0_1 : tensor<3x3xf32>
  %c1_2 = arith.constant 1 : index
  %dim_3 = tensor.dim %arg0, %c1_2 : tensor<3x3xf32>
  ...
  %5 = linalg.matmul ins(%arg0, %cast : tensor<3x3xf32>, tensor<3x3xf32>) outs(%4 : tensor<?x?xf32>) -> tensor<?x?xf32>
  %cast_9 = tensor.cast %5 : tensor<?x?xf32> to tensor<3x3xf32>
  return %cast_9 : tensor<3x3xf32>
}

// -----// IR Dump After LinalgBufferize (linalg-bufferize) //----- //
func.func @forward(%arg0: tensor<3x3xf32>) -> tensor<3x3xf32> {
  %0 = bufferization.to_memref %arg0 : memref<3x3xf32>
  %c0_i64 = arith.constant 0 : i64
  %c1_i64 = arith.constant 1 : i64
  %cst = arith.constant dense<[[-0.533737481, 0.0726815313, 0.548144102], [0.339588523, -0.212466493, 0.129553705], [0.423136026, 0.46056211, -0.0355117619]]> : tensor<3x3xf32>
  ...
  linalg.matmul ins(%0, %4 : memref<3x3xf32>, memref<3x3xf32>) outs(%alloc_14 : memref<?x?xf32>)
  %7 = bufferization.to_tensor %alloc_14 : memref<?x?xf32>
  %cast_15 = tensor.cast %7 : tensor<?x?xf32> to tensor<3x3xf32>
  return %cast_15 : tensor<3x3xf32>
}
...
module attributes {torch.debug_module_name = "L"} {
  func.func @forward(%arg0: tensor<3x3xf32>) -> tensor<3x3xf32> {
    ...
    %cst_0 = arith.constant dense<[[-0.533737481, 0.0726815313, 0.548144102], [0.339588523, -0.212466493, 0.129553705], [0.423136026, 0.46056211, -0.0355117619]]> : tensor<3x3xf32>
    %0 = bufferization.to_memref %arg0 : memref<3x3xf32>
    ...
    %alloc_1 = memref.alloc(%c3, %c3) {alignment = 64 : i64} : memref<?x?xf32>
    linalg.fill ins(%cst : f32) outs(%alloc_1 : memref<?x?xf32>)
    %alloc_2 = memref.alloc(%c3, %c3) {alignment = 64 : i64} : memref<?x?xf32>
    memref.copy %alloc_1, %alloc_2 : memref<?x?xf32> to memref<?x?xf32>
    linalg.matmul ins(%0, %alloc : memref<3x3xf32>, memref<3x3xf32>) outs(%alloc_2 : memref<?x?xf32>)
    %2 = bufferization.to_tensor %alloc_2 : memref<?x?xf32>
    %cast = tensor.cast %2 : tensor<?x?xf32> to tensor<3x3xf32>
    return %cast : tensor<3x3xf32>
  }
}
...
func.func @forward(%arg0: tensor<3x3xf32>) -> tensor<3x3xf32> {
  ...
  memref.copy %alloc_1, %alloc_2 : memref<?x?xf32> to memref<?x?xf32>
  linalg.matmul ins(%0, %alloc : memref<3x3xf32>, memref<3x3xf32>) outs(%alloc_2 : memref<?x?xf32>)
  %cast = memref.cast %alloc_2 : memref<?x?xf32> to memref<3x3xf32>
  %2 = bufferization.to_tensor %cast : memref<3x3xf32>
...
module attributes {torch.debug_module_name = "L"} {
  func.func @forward(%arg0: memref<3x3xf32>) -> memref<3x3xf32> {
    %0 = bufferization.to_tensor %arg0 : memref<3x3xf32>
    %c3 = arith.constant 3 : index
    %true = arith.constant true
    %cst = arith.constant 0.000000e+00 : f32
    %cst_0 = arith.constant dense<[[-0.533737481, 0.0726815313, 0.548144102], [0.339588523, -0.212466493, 0.129553705], [0.423136026, 0.46056211, -0.0355117619]]> : tensor<3x3xf32>
    %1 = bufferization.to_memref %0 : memref<3x3xf32>
    ...
    %alloc_2 = memref.alloc(%c3, %c3) {alignment = 64 : i64} : memref<?x?xf32>
    memref.copy %alloc_1, %alloc_2 : memref<?x?xf32> to memref<?x?xf32>
    linalg.matmul ins(%1, %alloc : memref<3x3xf32>, memref<3x3xf32>) outs(%alloc_2 : memref<?x?xf32>)
    %cast = memref.cast %alloc_2 : memref<?x?xf32> to memref<3x3xf32>
    %3 = bufferization.to_tensor %cast : memref<3x3xf32>
    %4 = bufferization.to_memref %3 : memref<3x3xf32>
    return %4 : memref<3x3xf32>
  }
}
...
module attributes {torch.debug_module_name = "L"} {
  ...
  func.func @forward(%arg0: memref<3x3xf32>) -> memref<3x3xf32> {
    ...
    cf.assert %true, "mismatching contracting dimension for torch.aten.mm"
    %alloc_0 = memref.alloc(%c3, %c3) {alignment = 64 : i64} : memref<?x?xf32>
    linalg.fill ins(%cst : f32) outs(%alloc_0 : memref<?x?xf32>)
    %alloc_1 = memref.alloc(%c3, %c3) {alignment = 64 : i64} : memref<?x?xf32>
    memref.copy %alloc_0, %alloc_1 : memref<?x?xf32> to memref<?x?xf32>
    linalg.matmul ins(%arg0, %alloc : memref<3x3xf32>, memref<3x3xf32>) outs(%alloc_1 : memref<?x?xf32>)
    %cast = memref.cast %alloc_1 : memref<?x?xf32> to memref<3x3xf32>
    return %cast : memref<3x3xf32>
  }
}
...
func.func @forward(%arg0: memref<3x3xf32>) -> memref<3x3xf32> {
  ...
  cf.assert %true, "mismatching contracting dimension for torch.aten.mm"
  %alloc = memref.alloc(%c3, %c3) {alignment = 64 : i64} : memref<?x?xf32>
  affine.for %arg1 = 0 to 3 {
    affine.for %arg2 = 0 to 3 {
  ...
  %cast = memref.cast %alloc_0 : memref<?x?xf32> to memref<3x3xf32>
  return %cast : memref<3x3xf32>
}
