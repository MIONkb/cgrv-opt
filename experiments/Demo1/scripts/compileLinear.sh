...
cgra-opt --affine-loop-fusion  --arith-expand --memref-expand -reconcile-unrealized-casts \
 --fdra-extract-kernel-to-function='kernel-gen-dir=/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/Demo1 kernel-explicit-datablock-trans=false' \
 1_kernel.mlir
