"func.func"() ({
^bb0(%arg0: memref<4x3xf32>, %arg1: memref<3x3xf32>, %arg2: memref<4x3xf32>):
  "cf.br"()[^bb1] : () -> ()
^bb1:  // pred: ^bb0
  "affine.for"() ({
  ^bb0(%arg3: index):
  ...
  "func.return"() : () -> ()
}) {Kernel, forward_kernel_2, function_type = (memref<4x3xf32>, memref<3x3xf32>, memref<4x3xf32>) -> (), sym_name = "forward_kernel_2"} : () -> ()