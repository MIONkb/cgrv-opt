"func.func"() ({
^bb0(%arg0: memref<4x8xf32>, %arg1: memref<4x8xf32>):
  "cf.br"()[^bb1] : () -> ()
^bb1:  // pred: ^bb0
  ...
  ^bb0(%arg2: index):
    "affine.for"() ({
    ^bb0(%arg3: index):
      %2 = "affine.load"(%arg0, %arg2, %arg3) {map = affine_map<(d0, d1) -> (d0, d1)>} : (memref<4x8xf32>, index, index) -> f32
      ...
      "affine.store"(%6, %arg1, %arg2, %arg3) {map = affine_map<(d0, d1) -> (d0, d1)>} : (f32, memref<4x8xf32>, index, index) -> ()
      "affine.yield"() : () -> ()
  ...
  "func.return"() : () -> ()
}) {Kernel, function_type = (memref<4x8xf32>, memref<4x8xf32>) -> (), main_kernel_10, sym_name = "main_kernel_10"} : () -> ()