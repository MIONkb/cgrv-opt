...
module attributes {tf.versions = {bad_consumers = [], min_consumer = 0 : i32, producer = 1087 : i32}} {
  ...
  func.func @main(%arg0: memref<4x32x32x1xf32>, %arg1: memref<4x2xf32>) attributes {tf.entry_function = {control_outputs = "", inputs = "x1", outputs = "Identity"}} {
        ...
        affine.for %arg3 = 0 to 5 {
          affine.for %arg4 = 0 to 5 {
            affine.for %arg5 = 0 to 1 {
              %38 = affine.load %3[%arg3, %arg4, %arg5, %arg2] : memref<5x5x1x1xf32>
              affine.store %38, %4[%arg2, %arg3, %arg4, %arg5] : memref<1x5x5x1xf32>
            }
          }
        }
      }
      ...
      affine.for %arg2 = 0 to 5 {
        affine.for %arg3 = 0 to 5 {
          affine.for %arg4 = 0 to 1 {
            affine.for %arg5 = 0 to 1 {
              %38 = affine.load %4[%arg5, %arg2, %arg3, %arg4] : memref<1x5x5x1xf32>
              affine.store %38, %8[%arg2, %arg3, %arg4, %arg5] : memref<5x5x1x1xf32>
            }
          }
        }
      }
              ...
              affine.for %arg6 = 0 to 5 {
                affine.for %arg7 = 0 to 5 {
                  affine.for %arg8 = 0 to 1 {
                    %38 = affine.load %6[%arg2, %arg3 * 2 + %arg6, %arg4 * 2 + %arg7, %arg8] : memref<4x35x35x1xf32>
                    %39 = affine.load %8[%arg6, %arg7, %arg8, %arg5] : memref<5x5x1x1xf32>
                    %40 = affine.load %10[%arg2, %arg3, %arg4, %arg5] : memref<4x16x16x1xf32>
                    %41 = arith.mulf %38, %39 : f32
                    %42 = arith.addf %40, %41 : f32
                    affine.store %42, %10[%arg2, %arg3, %arg4, %arg5] : memref<4x16x16x1xf32>
                  }
                }
              }
            }
        ...
        affine.for %arg3 = 0 to 16 {
          affine.for %arg4 = 0 to 16 {
            affine.for %arg5 = 0 to 1 {
              ...
              %41 = arith.cmpf olt, %cst_0, %38 : f32
              %42 = arith.select %41, %cst_0, %40 : f32
    ...
    FDRA.kernel {
      affine.for %arg2 = 0 to 4 {
        affine.for %arg3 = 0 to 8 {
          %38 = affine.load %18[%arg2, %arg3] : memref<4x8xf32>
          %39 = arith.cmpf olt, %38, %cst : f32
          %40 = arith.select %39, %cst, %38 : f32
          %41 = arith.cmpf olt, %cst_0, %38 : f32
          %42 = arith.select %41, %cst_0, %40 : f32
          affine.store %42, %19[%arg2, %arg3] : memref<4x8xf32>
        }
      }
      FDRA.terminator
    }
    ...
    FDRA.kernel {
      affine.for %arg2 = 0 to 4 {
        affine.for %arg3 = 0 to 4 {
          %38 = affine.load %24[%arg2, %arg3] : memref<4x4xf32>
          %39 = arith.cmpf olt, %38, %cst : f32
          %40 = arith.select %39, %cst, %38 : f32
          %41 = arith.cmpf olt, %cst_0, %38 : f32
          %42 = arith.select %41, %cst_0, %40 : f32
          affine.store %42, %25[%arg2, %arg3] : memref<4x4xf32>
        }
      }
      FDRA.terminator
    }
    ...
    FDRA.kernel {
      affine.for %arg2 = 0 to 4 {
        affine.for %arg3 = 0 to 2 {
          %38 = affine.load %30[%arg2, %arg3] : memref<4x2xf32>
          %39 = math.exp %38 : f32
          affine.store %39, %31[%arg2, %arg3] : memref<4x2xf32>
        }
      }
      FDRA.terminator
    }
