...
for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  ...
  %0 = mul i32 %orow.0100, 672
  %mul24.2 = add i32 %0, 1344
...
cond.end.2.2.2:                                   ; preds = %for.cond1.preheader, %cond.end.2.2.2
  ...
  %1 = load i32, ptr %add.ptr26, align 4, !tbaa !9
  %2 = load i32, ptr %weights, align 4, !tbaa !9
  %mul34 = mul nsw i32 %2, %1
  %add.ptr27.1 = getelementptr inbounds i32, ptr %add.ptr26, i32 1
  %3 = load i32, ptr %add.ptr27.1, align 4, !tbaa !9
  %4 = load i32, ptr %add.ptr33.1, align 4, !tbaa !9
  %mul34.1 = mul nsw i32 %4, %3
  %add35.1 = add nsw i32 %mul34.1, %mul34
  %add.ptr27.2 = getelementptr inbounds i32, ptr %add.ptr26, i32 2
  %5 = load i32, ptr %add.ptr27.2, align 4, !tbaa !9
  %6 = load i32, ptr %add.ptr33.2, align 4, !tbaa !9
  %mul34.2 = mul nsw i32 %6, %5
  ...
  %7 = load i32, ptr %add.ptr26.1, align 4, !tbaa !9
  %8 = load i32, ptr %add.ptr32.1, align 4, !tbaa !9
  %mul34.1103 = mul nsw i32 %8, %7
  %add35.1104 = add nsw i32 %mul34.1103, %add35.2
  %add.ptr27.1.1 = getelementptr inbounds i32, ptr %add.ptr26.1, i32 1
  %9 = load i32, ptr %add.ptr27.1.1, align 4, !tbaa !9
  %10 = load i32, ptr %add.ptr33.1.1, align 4, !tbaa !9
  %mul34.1.1 = mul nsw i32 %10, %9
  %add35.1.1 = add nsw i32 %mul34.1.1, %add35.1104
  %add.ptr27.2.1 = getelementptr inbounds i32, ptr %add.ptr26.1, i32 2
  %11 = load i32, ptr %add.ptr27.2.1, align 4, !tbaa !9
  %12 = load i32, ptr %add.ptr33.2.1, align 4, !tbaa !9
  %mul34.2.1 = mul nsw i32 %12, %11
  %add35.2.1 = add nsw i32 %mul34.2.1, %add35.1.1
  %13 = mul i32 %ocol.099, 3
  %mul25.2 = add i32 %13, 6
  %add.ptr26.2 = getelementptr inbounds i32, ptr %add.ptr, i32 %mul25.2
  %14 = load i32, ptr %add.ptr26.2, align 4, !tbaa !9
  %15 = load i32, ptr %add.ptr32.2, align 4, !tbaa !9
  %mul34.2108 = mul nsw i32 %15, %14
  %add35.2109 = add nsw i32 %mul34.2108, %add35.2.1
  %add.ptr27.1.2 = getelementptr inbounds i32, ptr %add.ptr26.2, i32 1
  %16 = load i32, ptr %add.ptr27.1.2, align 4, !tbaa !9
  %17 = load i32, ptr %add.ptr33.1.2, align 4, !tbaa !9
  %mul34.1.2 = mul nsw i32 %17, %16
  %add35.1.2 = add nsw i32 %mul34.1.2, %add35.2109
  %add.ptr27.2.2 = getelementptr inbounds i32, ptr %add.ptr26.2, i32 2
  %18 = load i32, ptr %add.ptr27.2.2, align 4, !tbaa !9
  %19 = load i32, ptr %add.ptr33.2.2, align 4, !tbaa !9
  %mul34.2.2 = mul nsw i32 %19, %18
  %add35.2.2 = add nsw i32 %mul34.2.2, %add35.1.2
  %add.ptr26.1112 = getelementptr inbounds i32, ptr %add.ptr.1, i32 %mul25
  %20 = load i32, ptr %add.ptr26.1112, align 4, !tbaa !9
  %21 = load i32, ptr %add.ptr30.1, align 4, !tbaa !9
  %mul34.1116 = mul nsw i32 %21, %20
  %add35.1117 = add nsw i32 %mul34.1116, %add35.2.2
  %add.ptr27.1.1119 = getelementptr inbounds i32, ptr %add.ptr26.1112, i32 1
  %22 = load i32, ptr %add.ptr27.1.1119, align 4, !tbaa !9
  %23 = load i32, ptr %add.ptr33.1.1122, align 4, !tbaa !9
  %mul34.1.1123 = mul nsw i32 %23, %22
  %add35.1.1124 = add nsw i32 %mul34.1.1123, %add35.1117
  %add.ptr27.2.1126 = getelementptr inbounds i32, ptr %add.ptr26.1112, i32 2
  %24 = load i32, ptr %add.ptr27.2.1126, align 4, !tbaa !9
  %25 = load i32, ptr %add.ptr33.2.1129, align 4, !tbaa !9
  %mul34.2.1130 = mul nsw i32 %25, %24
  %add35.2.1131 = add nsw i32 %mul34.2.1130, %add35.1.1124
  %add.ptr26.1.1 = getelementptr inbounds i32, ptr %add.ptr.1, i32 %mul25.1
  %26 = load i32, ptr %add.ptr26.1.1, align 4, !tbaa !9
  %27 = load i32, ptr %add.ptr32.1.1, align 4, !tbaa !9
  %mul34.1103.1 = mul nsw i32 %27, %26
  %add35.1104.1 = add nsw i32 %mul34.1103.1, %add35.2.1131
  %add.ptr27.1.1.1 = getelementptr inbounds i32, ptr %add.ptr26.1.1, i32 1
  %28 = load i32, ptr %add.ptr27.1.1.1, align 4, !tbaa !9
  %29 = load i32, ptr %add.ptr33.1.1.1, align 4, !tbaa !9
  %mul34.1.1.1 = mul nsw i32 %29, %28
  %add35.1.1.1 = add nsw i32 %mul34.1.1.1, %add35.1104.1
  %add.ptr27.2.1.1 = getelementptr inbounds i32, ptr %add.ptr26.1.1, i32 2
  %30 = load i32, ptr %add.ptr27.2.1.1, align 4, !tbaa !9
  %31 = load i32, ptr %add.ptr33.2.1.1, align 4, !tbaa !9
  %mul34.2.1.1 = mul nsw i32 %31, %30
  %add35.2.1.1 = add nsw i32 %mul34.2.1.1, %add35.1.1.1
  %add.ptr26.2.1 = getelementptr inbounds i32, ptr %add.ptr.1, i32 %mul25.2
  %32 = load i32, ptr %add.ptr26.2.1, align 4, !tbaa !9
  %33 = load i32, ptr %add.ptr32.2.1, align 4, !tbaa !9
  %mul34.2108.1 = mul nsw i32 %33, %32
  %add35.2109.1 = add nsw i32 %mul34.2108.1, %add35.2.1.1
  %add.ptr27.1.2.1 = getelementptr inbounds i32, ptr %add.ptr26.2.1, i32 1
  %34 = load i32, ptr %add.ptr27.1.2.1, align 4, !tbaa !9
  %35 = load i32, ptr %add.ptr33.1.2.1, align 4, !tbaa !9
  %mul34.1.2.1 = mul nsw i32 %35, %34
  %add35.1.2.1 = add nsw i32 %mul34.1.2.1, %add35.2109.1
  %add.ptr27.2.2.1 = getelementptr inbounds i32, ptr %add.ptr26.2.1, i32 2
  %36 = load i32, ptr %add.ptr27.2.2.1, align 4, !tbaa !9
  %37 = load i32, ptr %add.ptr33.2.2.1, align 4, !tbaa !9
  %mul34.2.2.1 = mul nsw i32 %37, %36
  %add35.2.2.1 = add nsw i32 %mul34.2.2.1, %add35.1.2.1
  %add.ptr26.2134 = getelementptr inbounds i32, ptr %add.ptr.2, i32 %mul25
  %38 = load i32, ptr %add.ptr26.2134, align 4, !tbaa !9
  %39 = load i32, ptr %add.ptr30.2, align 4, !tbaa !9
  %mul34.2138 = mul nsw i32 %39, %38
  %add35.2139 = add nsw i32 %mul34.2138, %add35.2.2.1
  %add.ptr27.1.2141 = getelementptr inbounds i32, ptr %add.ptr26.2134, i32 1
  %40 = load i32, ptr %add.ptr27.1.2141, align 4, !tbaa !9
  %41 = load i32, ptr %add.ptr33.1.2144, align 4, !tbaa !9
  %mul34.1.2145 = mul nsw i32 %41, %40
  %add35.1.2146 = add nsw i32 %mul34.1.2145, %add35.2139
  %add.ptr27.2.2148 = getelementptr inbounds i32, ptr %add.ptr26.2134, i32 2
  %42 = load i32, ptr %add.ptr27.2.2148, align 4, !tbaa !9
  %43 = load i32, ptr %add.ptr33.2.2151, align 4, !tbaa !9
  %mul34.2.2152 = mul nsw i32 %43, %42
  %add35.2.2153 = add nsw i32 %mul34.2.2152, %add35.1.2146
  %add.ptr26.1.2 = getelementptr inbounds i32, ptr %add.ptr.2, i32 %mul25.1
  %44 = load i32, ptr %add.ptr26.1.2, align 4, !tbaa !9
  %45 = load i32, ptr %add.ptr32.1.2, align 4, !tbaa !9
  %mul34.1103.2 = mul nsw i32 %45, %44
  %add35.1104.2 = add nsw i32 %mul34.1103.2, %add35.2.2153
  %add.ptr27.1.1.2 = getelementptr inbounds i32, ptr %add.ptr26.1.2, i32 1
  %46 = load i32, ptr %add.ptr27.1.1.2, align 4, !tbaa !9
  %47 = load i32, ptr %add.ptr33.1.1.2, align 4, !tbaa !9
  %mul34.1.1.2 = mul nsw i32 %47, %46
  %add35.1.1.2 = add nsw i32 %mul34.1.1.2, %add35.1104.2
  %add.ptr27.2.1.2 = getelementptr inbounds i32, ptr %add.ptr26.1.2, i32 2
  %48 = load i32, ptr %add.ptr27.2.1.2, align 4, !tbaa !9
  %49 = load i32, ptr %add.ptr33.2.1.2, align 4, !tbaa !9
  %mul34.2.1.2 = mul nsw i32 %49, %48
  %add35.2.1.2 = add nsw i32 %mul34.2.1.2, %add35.1.1.2
  %add.ptr26.2.2 = getelementptr inbounds i32, ptr %add.ptr.2, i32 %mul25.2
  %50 = load i32, ptr %add.ptr26.2.2, align 4, !tbaa !9
  %51 = load i32, ptr %add.ptr32.2.2, align 4, !tbaa !9
  %mul34.2108.2 = mul nsw i32 %51, %50
  %add35.2109.2 = add nsw i32 %mul34.2108.2, %add35.2.1.2
  %add.ptr27.1.2.2 = getelementptr inbounds i32, ptr %add.ptr26.2.2, i32 1
  %52 = load i32, ptr %add.ptr27.1.2.2, align 4, !tbaa !9
  %53 = load i32, ptr %add.ptr33.1.2.2, align 4, !tbaa !9
  %mul34.1.2.2 = mul nsw i32 %53, %52
  %add35.1.2.2 = add nsw i32 %mul34.1.2.2, %add35.2109.2
  %add.ptr27.2.2.2 = getelementptr inbounds i32, ptr %add.ptr26.2.2, i32 2
  %54 = load i32, ptr %add.ptr27.2.2.2, align 4, !tbaa !9
  %55 = load i32, ptr %add.ptr33.2.2.2, align 4, !tbaa !9
  %mul34.2.2.2 = mul nsw i32 %55, %54
  %add35.2.2.2 = add nsw i32 %mul34.2.2.2, %add35.1.2.2
  %56 = load i32, ptr %bias, align 4, !tbaa !9
  %add42 = add nsw i32 %56, %add35.2.2.2
