        ...
        affine.for %arg2 = 0 to 222 step 3 {
          FDRA.kernel {
            affine.for %arg3 = #map0(%arg2) to #map1(%arg2) {
              ...
              affine.for %arg4 = 0 to 222 {
                %6 = arith.index_cast %arg4 : index to i32
                %7 = affine.for %arg5 = 0 to 3 iter_args(%arg6 = %c0_i32) -> (i32) {
                  %12 = arith.index_cast %arg5 : index to i32
                  %13 = arith.addi %5, %12 : i32
                  %14 = affine.if #set(%arg3, %arg5) -> i1 {
                    affine.yield %true : i1
                  } else {
                    %16 = arith.cmpi sge, %13, %c224_i32 : i32
                    affine.yield %16 : i1
                  }
                  %15 = affine.for %arg7 = 0 to 3 iter_args(%arg8 = %arg6) -> (i32) {
                    %16 = arith.index_cast %arg7 : index to i32
                    ...
                    %20 = affine.for %arg9 = 0 to 3 iter_args(%arg10 = %arg8) -> (i32) {
                      %21 = scf.if %19 -> (i32) {
                        scf.yield %c0_i32 : i32
                      } else {
                        %25 = affine.load %1[%arg0, %arg3 + %arg5, %arg4 + %arg7, %arg9] : memref<4x224x224x3xi32>
                        scf.yield %25 : i32
                      }
                      %22 = affine.load %0[%arg1, %arg5, %arg7, %arg9] : memref<32x3x3x3xi32>
                      %23 = arith.muli %22, %21 : i32
                      %24 = arith.addi %arg10, %23 : i32
                      affine.yield %24 : i32
                    }
                    affine.yield %20 : i32
                  }
                ...
                affine.store %11, %3[%arg0, %arg3, %arg4, %arg1] : memref<4x222x222x32xi32>
              }
            }
            FDRA.terminator
          }
