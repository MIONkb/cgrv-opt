...
^bb1:  // pred: ^bb0
  ...
  ^bb0(%arg1: index):
    ...
    ^bb0(%arg2: index):
      ...
      ^bb0(%arg3: index):
        "affine.for"() ({
        ^bb0(%arg4: index):
          "affine.store"(%0, %arg0, %arg1, %arg2, %arg3, %arg4) {map = affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>} : (f32, memref<1x3x230x230xf32>, index, index, index, index) -> ()
          "affine.yield"() : () -> ()
  ...
  "func.return"() : () -> ()
}) {Kernel, forward_kernel_0, function_type = (memref<1x3x230x230xf32>) -> (), sym_name = "forward_kernel_0"} : () -> ()