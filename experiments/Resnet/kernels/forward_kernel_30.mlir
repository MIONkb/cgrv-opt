...
^bb1:  // pred: ^bb0
  ...
  "func.return"() : () -> ()
}) {Kernel, forward_kernel_30, function_type = (memref<128xf32>, memref<128xf32>, memref<128xf32>, memref<128xf32>, memref<1x128x28x28xf32>, memref<1x128x28x28xf32>) -> (), sym_name = "forward_kernel_30"} : () -> ()