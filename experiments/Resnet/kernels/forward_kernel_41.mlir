"func.func"() ({
^bb0(%arg0: memref<1x256x14x14xf32>, %arg1: memref<1x128x30x30xf32>, %arg2: memref<256x128x3x3xf32>):
  "cf.br"()[^bb1] : () -> ()
^bb1:  // pred: ^bb0
  "affine.for"() ({
  ^bb0(%arg3: index):
          ...
          ^bb0(%arg7: index, %arg8: f32):
            ...
            ^bb0(%arg9: index, %arg10: f32):
              ...
              ^bb0(%arg11: index, %arg12: f32):
                %4 = "affine.load"(%arg1, %arg3, %arg7, %arg5, %arg9, %arg6, %arg11) {map = affine_map<(d0, d1, d2, d3, d4, d5) -> (d0, d1, d2 * 2 + d3, d4 * 2 + d5)>} : (memref<1x128x30x30xf32>, index, index, index, index, index, index) -> f32
                %5 = "affine.load"(%arg2, %arg4, %arg7, %arg9, %arg11) {map = affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>} : (memref<256x128x3x3xf32>, index, index, index, index) -> f32
  ...
  "func.return"() : () -> ()
}) {Kernel, forward_kernel_41, function_type = (memref<1x256x14x14xf32>, memref<1x128x30x30xf32>, memref<256x128x3x3xf32>) -> (), sym_name = "forward_kernel_41"} : () -> ()