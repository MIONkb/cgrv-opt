"func.func"() <{function_type = (memref<64xf32>, memref<64xf32>, memref<64xf32>, memref<64xf32>, memref<1x64x112x112xf32>, memref<1x64x112x112xf32>) -> (), sym_name = "forward_kernel_1"}> ({
...
^bb1:  // pred: ^bb0
  ...
  "affine.for"() ({
  ^bb0(%arg6: index):
    %1 = "affine.load"(%arg0) {map = affine_map<() -> (0)>} : (memref<64xf32>) -> f32
    ...
    "affine.for"() ({
    ^bb0(%arg7: index):
      %5 = "affine.load"(%arg4, %arg6, %arg7) {map = affine_map<(d0, d1) -> (0, 0, d0, d1)>} : (memref<1x64x112x112xf32>, index, index) -> f32
      ...
      %21 = "arith.subf"(%5, %3) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
      %22 = "arith.mulf"(%21, %20) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
      %23 = "arith.mulf"(%22, %1) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
      %24 = "arith.addf"(%23, %2) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
