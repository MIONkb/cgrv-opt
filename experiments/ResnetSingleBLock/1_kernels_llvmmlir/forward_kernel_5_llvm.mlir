module attributes {llvm.data_layout = ""} {
  llvm.func @forward_kernel_5(%arg0: !llvm.ptr) attributes {Kernel, forward_kernel_5} {
    ...
    %7 = llvm.mlir.constant(831744 : index) : i64
    ...
    %25 = llvm.mlir.constant(0xFF800000 : f32) : f32
    llvm.br ^bb1
  ^bb1:  // pred: ^bb0
    llvm.br ^bb2(%24 : i64)
