module attributes {llvm.data_layout = ""} {
  llvm.func @forward_kernel_0(%arg0: !llvm.ptr) attributes {Kernel, forward_kernel_0} {
    ...
    %7 = llvm.mlir.constant(158700 : index) : i64
    ...
    %17 = llvm.mlir.constant(230 : index) : i64
  ...
  ^bb9:  // pred: ^bb8
    ...
    %35 = llvm.mlir.constant(158700 : index) : i64
    %36 = llvm.mul %26, %35  : i64
    %37 = llvm.mlir.constant(52900 : index) : i64
    %38 = llvm.mul %28, %37  : i64
    %39 = llvm.add %36, %38  : i64
    %40 = llvm.mlir.constant(230 : index) : i64
