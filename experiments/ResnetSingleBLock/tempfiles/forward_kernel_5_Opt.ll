; ModuleID = '/home/tianyi/fdra/app-compiler/cgra-opt/experiments/ResnetSingleBLock/2_kernels_llvm/forward_kernel_5.ll'
source_filename = "LLVMDialectModule"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: write)
define void @forward_kernel_5(ptr nocapture writeonly %0) local_unnamed_addr #0 {
.preheader2:
  br label %.preheader1

.preheader1:                                      ; preds = %.preheader2, %15
  %1 = phi i64 [ 0, %.preheader2 ], [ %16, %15 ]
  %2 = mul nuw nsw i64 %1, 12996
  br label %.preheader

.preheader:                                       ; preds = %.preheader1, %12
  %3 = phi i64 [ 0, %.preheader1 ], [ %13, %12 ]
  %4 = mul nuw nsw i64 %3, 114
...
6:                                                ; preds = %.preheader, %6
  ...
  %11 = icmp ult i64 %7, 113
  br i1 %11, label %6, label %12

12:                                               ; preds = %6
  %13 = add nuw nsw i64 %3, 1
  %14 = icmp ult i64 %3, 113
