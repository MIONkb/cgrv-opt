...
define void @main_kernel_21(ptr %0, ptr %1) !dbg !3 {
  ...
  %8 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %7, i64 1, 3, 1, !dbg !13
  ...
  %14 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %13, i64 1, 4, 0, !dbg !19
  %15 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %14, i64 1, 3, 1, !dbg !20
...
18:                                               ; preds = %35, %17
  %19 = phi i64 [ %36, %35 ], [ 0, %17 ]
  %20 = icmp slt i64 %19, 4, !dbg !24
  br i1 %20, label %21, label %37, !dbg !25
...
22:                                               ; preds = %25, %21
  ...
  %24 = icmp slt i64 %23, 1, !dbg !27
  br i1 %24, label %25, label %35, !dbg !28

25:                                               ; preds = %22
  %26 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %9, 1, !dbg !29
  %27 = add i64 %19, %23, !dbg !30
  %28 = getelementptr float, ptr %26, i64 %27, !dbg !31
  %29 = load float, ptr %28, align 4, !dbg !32
  %30 = fdiv float 1.000000e+00, %29, !dbg !33
  %31 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %16, 1, !dbg !34
  %32 = add i64 %19, %23, !dbg !35
  %33 = getelementptr float, ptr %31, i64 %32, !dbg !36
  store float %30, ptr %33, align 4, !dbg !37
  %34 = add i64 %23, 1, !dbg !38
  br label %22, !dbg !39

35:                                               ; preds = %22
  %36 = add i64 %19, 1, !dbg !40
  br label %18, !dbg !41
...
!4 = !DIFile(filename: "ConvModel/1_kernels_llvmmlir/main_kernel_21_llvm.mlir", directory: "/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest")
