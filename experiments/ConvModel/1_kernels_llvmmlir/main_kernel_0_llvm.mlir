module attributes {llvm.data_layout = ""} {
  llvm.func @main_kernel_0(%arg0: !llvm.ptr<f32>, %arg1: !llvm.ptr<f32>) attributes {main_kernel_0} {
  ...
  ^bb9:  // pred: ^bb8
    ...
    %57 = llvm.add %56, %51  : i64
    %58 = llvm.add %57, %45  : i64
    %59 = llvm.getelementptr %53[%58] : (!llvm.ptr<f32>, i64) -> !llvm.ptr<f32>
    %60 = llvm.load %59 : !llvm.ptr<f32>
    %61 = llvm.extractvalue %41[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)> 
    %62 = llvm.mlir.constant(25 : index) : i64
    %63 = llvm.mul %45, %62  : i64
    %64 = llvm.mlir.constant(5 : index) : i64
    %65 = llvm.mul %47, %64  : i64
    %66 = llvm.add %63, %65  : i64
    %67 = llvm.add %66, %49  : i64
    %68 = llvm.add %67, %51  : i64
    %69 = llvm.getelementptr %61[%68] : (!llvm.ptr<f32>, i64) -> !llvm.ptr<f32>
    llvm.store %60, %69 : !llvm.ptr<f32>
    %70 = llvm.add %51, %43  : i64
    llvm.br ^bb8(%70 : i64)
  ^bb10:  // pred: ^bb8
    %71 = llvm.add %49, %43  : i64
    llvm.br ^bb6(%71 : i64)
  ^bb11:  // pred: ^bb6
    %72 = llvm.add %47, %43  : i64
    llvm.br ^bb4(%72 : i64)
  ^bb12:  // pred: ^bb4
    %73 = llvm.add %45, %43  : i64
    llvm.br ^bb2(%73 : i64)
  ^bb13:  // pred: ^bb2
    llvm.return
  }
