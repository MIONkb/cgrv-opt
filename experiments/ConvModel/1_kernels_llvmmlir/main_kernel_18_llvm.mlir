module attributes {llvm.data_layout = ""} {
  llvm.func @main_kernel_18(%arg0: !llvm.ptr<f32>, %arg1: !llvm.ptr<f32>) attributes {main_kernel_18} {
  ...
  ^bb5:  // pred: ^bb4
    ...
    %40 = "llvm.intr.exp"(%39) : (f32) -> f32
    %41 = llvm.extractvalue %25[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<2 x i64>, array<2 x i64>)> 
    ...
    llvm.store %40, %45 : !llvm.ptr<f32>
    %46 = llvm.add %32, %27  : i64
    llvm.br ^bb4(%46 : i64)
  ^bb6:  // pred: ^bb4
    %47 = llvm.add %30, %27  : i64
    llvm.br ^bb2(%47 : i64)
  ^bb7:  // pred: ^bb2
    llvm.return
  }
