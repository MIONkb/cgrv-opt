module attributes {llvm.data_layout = ""} {
  llvm.func @main_kernel_13(%arg0: !llvm.ptr<f32>, %arg1: !llvm.ptr<f32>) attributes {main_kernel_13} {
  ...
  ^bb5:  // pred: ^bb4
    ...
    %46 = llvm.add %32, %26  : i64
    llvm.br ^bb4(%46 : i64)
  ^bb6:  // pred: ^bb4
    %47 = llvm.add %30, %26  : i64
    llvm.br ^bb2(%47 : i64)
  ^bb7:  // pred: ^bb2
    llvm.return
  }
