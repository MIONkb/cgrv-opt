module attributes {llvm.data_layout = ""} {
  llvm.func @main_kernel_1(%arg0: !llvm.ptr<f32>) attributes {main_kernel_1} {
    ...
    %21 = llvm.mlir.constant(35 : index) : i64
  ...
  ^bb9:  // pred: ^bb8
    ...
    %35 = llvm.mlir.constant(1225 : index) : i64
    %36 = llvm.mul %26, %35  : i64
    %37 = llvm.mlir.constant(35 : index) : i64
