module attributes {llvm.data_layout = ""} {
  llvm.func @main_kernel_20(%arg0: !llvm.ptr<f32>, %arg1: !llvm.ptr<f32>) attributes {main_kernel_20} {
  ...
  ^bb5:  // pred: ^bb4
    %30 = llvm.extractvalue %12[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<2 x i64>, array<2 x i64>)> 
    ...
    %36 = llvm.extractvalue %21[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)> 
    %37 = llvm.getelementptr %36[%26] : (!llvm.ptr<f32>, i64) -> !llvm.ptr<f32>
    %38 = llvm.load %37 : !llvm.ptr<f32>
    %39 = llvm.fadd %35, %38  : f32
    %40 = llvm.extractvalue %21[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)> 
    %41 = llvm.getelementptr %40[%26] : (!llvm.ptr<f32>, i64) -> !llvm.ptr<f32>
    llvm.store %39, %41 : !llvm.ptr<f32>
    %42 = llvm.add %28, %23  : i64
    llvm.br ^bb4(%42 : i64)
  ^bb6:  // pred: ^bb4
    %43 = llvm.add %26, %23  : i64
    llvm.br ^bb2(%43 : i64)
  ^bb7:  // pred: ^bb2
    llvm.return
  }
