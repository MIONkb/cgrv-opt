...
module attributes {tf.versions = {bad_consumers = [], min_consumer = 0 : i32, producer = 1087 : i32}} {
  ...
  func.func @main(%arg0: memref<4x32x32x1xf32>, %arg1: memref<4x2xf32>) attributes {tf.entry_function = {control_outputs = "", inputs = "x1", outputs = "Identity"}} {
      ...
      affine.for %arg3 = 0 to 35 {
        affine.for %arg4 = 0 to 35 {
          affine.for %arg5 = 0 to 1 {
            affine.store %cst, %5[%arg2, %arg3, %arg4, %arg5] : memref<4x35x35x1xf32>
          }
        }
      }
    }
    ...
    %7 = memref.subview %6[0, 1, 1, 0] [4, 32, 32, 1] [1, 1, 1, 1] : memref<4x35x35x1xf32> to memref<4x32x32x1xf32, #map0>
    memref.copy %arg0, %7 : memref<4x32x32x1xf32> to memref<4x32x32x1xf32, #map0>
    %8 = memref.alloc() {alignment = 128 : i64} : memref<5x5x1x1xf32>
    affine.for %arg2 = 0 to 5 {
      affine.for %arg3 = 0 to 5 {
        affine.for %arg4 = 0 to 1 {
          affine.for %arg5 = 0 to 1 {
            %38 = affine.load %3[%arg2, %arg3, %c0, %c0_0] : memref<5x5x1x1xf32>
            affine.store %38, %4[%c0_0, %arg2, %arg3, %c0] : memref<1x5x5x1xf32>
            %39 = affine.load %4[%arg5, %arg2, %arg3, %arg4] : memref<1x5x5x1xf32>
            affine.store %39, %8[%arg2, %arg3, %arg4, %arg5] : memref<5x5x1x1xf32>
          }
        }
      }
    }
    ...
    affine.for %arg2 = 0 to 4 {
      affine.for %arg3 = 0 to 16 {
        affine.for %arg4 = 0 to 16 {
          affine.for %arg5 = 0 to 1 {
            affine.store %cst, %9[%arg2, %arg3, %arg4, %arg5] : memref<4x16x16x1xf32>
          }
        }
      }
    }
            ...
            affine.for %arg6 = 0 to 1 {
              affine.for %arg7 = 0 to 5 {
                affine.for %arg8 = 0 to 5 {
                  %38 = affine.apply #map1(%arg3, %arg7)
                  %39 = affine.apply #map1(%arg4, %arg8)
                  %40 = affine.load %6[%arg2, %38, %39, %arg6] : memref<4x35x35x1xf32>
                  %41 = affine.load %8[%arg7, %arg8, %arg6, %arg5] : memref<5x5x1x1xf32>
                  %42 = affine.load %10[%arg2, %arg3, %arg4, %arg5] : memref<4x16x16x1xf32>
                  %43 = arith.mulf %40, %41 : f32
                  %44 = arith.addf %42, %43 : f32
                  affine.store %44, %10[%arg2, %arg3, %arg4, %arg5] : memref<4x16x16x1xf32>
                }
              }
            }
          }
    ...
    affine.for %arg2 = 0 to 4 {
      affine.for %arg3 = 0 to 16 {
        affine.for %arg4 = 0 to 16 {
          affine.for %arg5 = 0 to 1 {
            %38 = affine.load %10[%arg2, %arg3, %arg4, %arg5] : memref<4x16x16x1xf32>
            %39 = arith.addf %38, %cst : f32
            affine.store %39, %11[%arg2, %arg3, %arg4, %arg5] : memref<4x16x16x1xf32>
          }
        }
      }
    }
    ...
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = 0 to 4 {
        affine.for %arg4 = 0 to 8 {
          affine.store %cst, %15[%arg2, %arg3, %arg4] : memref<1x4x8xf32>
        }
      }
    }
      ...
      affine.for %arg3 = 0 to 4 {
        affine.for %arg4 = 0 to 8 {
          affine.for %arg5 = 0 to 256 {
            %38 = affine.load %14[%arg2, %arg3, %arg5] : memref<1x4x256xf32>
            %39 = affine.load %2[%arg2, %arg5, %arg4] : memref<1x256x8xf32>
            %40 = affine.load %16[%arg2, %arg3, %arg4] : memref<1x4x8xf32>
            %41 = arith.mulf %38, %39 : f32
            %42 = arith.addf %40, %41 : f32
            affine.store %42, %16[%arg2, %arg3, %arg4] : memref<1x4x8xf32>
          }
        }
      }
    }
    ...
    affine.for %arg2 = 0 to 4 {
      affine.for %arg3 = 0 to 8 {
        %38 = affine.load %17[%arg2, %arg3] : memref<4x8xf32>
        %39 = arith.addf %38, %cst : f32
        affine.store %39, %18[%arg2, %arg3] : memref<4x8xf32>
        %40 = affine.load %18[%arg2, %arg3] : memref<4x8xf32>
        %41 = arith.cmpf olt, %40, %cst : f32
        %42 = arith.select %41, %cst, %40 : f32
        %43 = arith.cmpf olt, %cst_1, %40 : f32
        %44 = arith.select %43, %cst_1, %42 : f32
        affine.store %44, %19[%arg2, %arg3] : memref<4x8xf32>
      }
    }
    ...
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = 0 to 4 {
        affine.for %arg4 = 0 to 4 {
          affine.store %cst, %21[%arg2, %arg3, %arg4] : memref<1x4x4xf32>
        }
      }
    }
      ...
      affine.for %arg3 = 0 to 4 {
        affine.for %arg4 = 0 to 4 {
          affine.for %arg5 = 0 to 8 {
            %38 = affine.load %20[%arg2, %arg3, %arg5] : memref<1x4x8xf32>
            %39 = affine.load %1[%arg2, %arg5, %arg4] : memref<1x8x4xf32>
            %40 = affine.load %22[%arg2, %arg3, %arg4] : memref<1x4x4xf32>
            %41 = arith.mulf %38, %39 : f32
            %42 = arith.addf %40, %41 : f32
            affine.store %42, %22[%arg2, %arg3, %arg4] : memref<1x4x4xf32>
          }
        }
      }
    }
    ...
    affine.for %arg2 = 0 to 4 {
      affine.for %arg3 = 0 to 4 {
        %38 = affine.load %23[%arg2, %arg3] : memref<4x4xf32>
        %39 = arith.addf %38, %cst : f32
        affine.store %39, %24[%arg2, %arg3] : memref<4x4xf32>
        %40 = affine.load %24[%arg2, %arg3] : memref<4x4xf32>
        %41 = arith.cmpf olt, %40, %cst : f32
        %42 = arith.select %41, %cst, %40 : f32
        %43 = arith.cmpf olt, %cst_1, %40 : f32
        %44 = arith.select %43, %cst_1, %42 : f32
        affine.store %44, %25[%arg2, %arg3] : memref<4x4xf32>
      }
    }
    ...
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = 0 to 4 {
        affine.for %arg4 = 0 to 2 {
          affine.store %cst, %27[%arg2, %arg3, %arg4] : memref<1x4x2xf32>
        }
      }
    }
      ...
      affine.for %arg3 = 0 to 4 {
        affine.for %arg4 = 0 to 2 {
          affine.for %arg5 = 0 to 4 {
            %38 = affine.load %26[%arg2, %arg3, %arg5] : memref<1x4x4xf32>
            %39 = affine.load %0[%arg2, %arg5, %arg4] : memref<1x4x2xf32>
            %40 = affine.load %28[%arg2, %arg3, %arg4] : memref<1x4x2xf32>
            %41 = arith.mulf %38, %39 : f32
            %42 = arith.addf %40, %41 : f32
            affine.store %42, %28[%arg2, %arg3, %arg4] : memref<1x4x2xf32>
          }
        }
      }
    }
    ...
    affine.for %arg2 = 0 to 4 {
      affine.for %arg3 = 0 to 2 {
        %38 = affine.load %29[%arg2, %arg3] : memref<4x2xf32>
        %39 = arith.addf %38, %cst : f32
        affine.store %39, %30[%arg2, %arg3] : memref<4x2xf32>
        %40 = affine.load %30[%arg2, %arg3] : memref<4x2xf32>
        %41 = math.exp %40 : f32
        affine.store %41, %31[%arg2, %arg3] : memref<4x2xf32>
      }
    }
    memref.dealloc %30 : memref<4x2xf32>
    %32 = memref.alloc() {alignment = 128 : i64} : memref<4xf32>
    affine.for %arg2 = 0 to 4 {
      affine.store %cst, %32[%arg2] : memref<4xf32>
    }
    ...
    affine.for %arg2 = 0 to 4 {
      affine.for %arg3 = 0 to 2 {
        %38 = affine.load %31[%arg2, %arg3] : memref<4x2xf32>
        %39 = affine.load %33[%arg2] : memref<4xf32>
        %40 = arith.addf %38, %39 : f32
        affine.store %40, %33[%arg2] : memref<4xf32>
      }
    }
    ...
    affine.for %arg2 = 0 to 4 {
      affine.for %arg3 = 0 to 1 {
        %38 = affine.load %34[%arg2, %arg3] : memref<4x1xf32>
        %39 = arith.divf %cst_2, %38 : f32
        affine.store %39, %35[%arg2, %arg3] : memref<4x1xf32>
      }
    }
    ...
    affine.for %arg2 = 0 to 4 {
      affine.for %arg3 = 0 to 2 {
        %38 = affine.load %31[%arg2, %arg3] : memref<4x2xf32>
        %39 = affine.load %36[%arg2] : memref<4xf32>
        %40 = arith.mulf %38, %39 : f32
        affine.store %40, %37[%arg2, %arg3] : memref<4x2xf32>
      }
    }
