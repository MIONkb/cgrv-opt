; ModuleID = '/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/ConvModel/2_kernels_llvm/main_kernel_7.ll'
...
define void @main_kernel_7(ptr %0) !dbg !3 {
  ...
  %6 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %5, i64 32, 4, 0, !dbg !12
  %7 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %6, i64 4, 3, 1, !dbg !13
  %8 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %7, i64 8, 4, 1, !dbg !14
  br label %9, !dbg !15
...
31:                                               ; preds = %9
  %32 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %8, i64 8, 3, 2, !dbg !33
...
!3 = distinct !DISubprogram(name: "main_kernel_7", linkageName: "main_kernel_7", scope: null, file: !4, line: 2, type: !5, scopeLine: 2, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
!4 = !DIFile(filename: "1_kernels_llvmmlir/main_kernel_7_llvm.mlir", directory: "/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/ConvModel")
