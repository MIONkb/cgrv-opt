; ModuleID = '/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/ConvModel/2_kernels_llvm/main_kernel_17.ll'
...
define void @main_kernel_17(ptr %0, ptr %1) !dbg !3 {
  ...
  %12 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %11, i64 2, 4, 0, !dbg !17
  br label %13, !dbg !18
...
16:                                               ; preds = %13
  %17 = mul nuw nsw i64 %14, 2
  br label %18, !dbg !21

18:                                               ; preds = %21, %16
  %19 = phi i64 [ %27, %21 ], [ 0, %16 ]
  %20 = icmp ult i64 %19, 2, !dbg !22
...
30:                                               ; preds = %13
  %31 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %7, i64 2, 3, 1, !dbg !34
  %32 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %12, i64 2, 3, 1, !dbg !35
...
!3 = distinct !DISubprogram(name: "main_kernel_17", linkageName: "main_kernel_17", scope: null, file: !4, line: 2, type: !5, scopeLine: 2, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
!4 = !DIFile(filename: "1_kernels_llvmmlir/main_kernel_17_llvm.mlir", directory: "/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/ConvModel")
