; ModuleID = '/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/ConvModel/2_kernels_llvm/main_kernel_16.ll'
...
define void @main_kernel_16(ptr %0, ptr %1, ptr %2) !dbg !3 {
  ...
  %8 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %7, i64 16, 4, 0, !dbg !12
  %9 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %8, i64 4, 3, 1, !dbg !13
  %10 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %9, i64 4, 4, 1, !dbg !14
  ...
  %15 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %14, i64 8, 4, 0, !dbg !19
  %16 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %15, i64 4, 3, 1, !dbg !20
  %17 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %16, i64 2, 4, 1, !dbg !21
  ...
  %22 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %21, i64 8, 4, 0, !dbg !26
  %23 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %22, i64 4, 3, 1, !dbg !27
  %24 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %23, i64 2, 4, 1, !dbg !28
  br label %25, !dbg !29
...
28:                                               ; preds = %25
  %29 = mul nuw nsw i64 %26, 16
  %30 = mul nuw nsw i64 %26, 8
  br label %31, !dbg !32
...
34:                                               ; preds = %31
  %35 = mul nuw nsw i64 %32, 4
  %36 = add nuw nsw i64 %29, %35
  %37 = mul nuw nsw i64 %32, 2
  %38 = add nuw nsw i64 %30, %37
  br label %39, !dbg !35

39:                                               ; preds = %61, %34
  %40 = phi i64 [ %62, %61 ], [ 0, %34 ]
  %41 = icmp ult i64 %40, 2, !dbg !36
...
48:                                               ; preds = %45
  ...
  %52 = mul nuw nsw i64 %46, 2, !dbg !44
  %53 = add nuw nsw i64 %30, %52, !dbg !45
...
67:                                               ; preds = %25
  %68 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %10, i64 4, 3, 2, !dbg !61
  %69 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %17, i64 2, 3, 2, !dbg !62
  %70 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %24, i64 2, 3, 2, !dbg !63
...
!3 = distinct !DISubprogram(name: "main_kernel_16", linkageName: "main_kernel_16", scope: null, file: !4, line: 2, type: !5, scopeLine: 2, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
!4 = !DIFile(filename: "1_kernels_llvmmlir/main_kernel_16_llvm.mlir", directory: "/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/ConvModel")
