; ModuleID = '/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/ConvModel/2_kernels_llvm/main_kernel_11.ll'
...
define void @main_kernel_11(ptr %0) !dbg !3 {
  ...
  %6 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %5, i64 16, 4, 0, !dbg !12
  %7 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %6, i64 4, 3, 1, !dbg !13
  %8 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %7, i64 4, 4, 1, !dbg !14
  br label %9, !dbg !15
...
17:                                               ; preds = %14
  %18 = mul nuw nsw i64 %15, 4
  %19 = add nuw nsw i64 %13, %18
  br label %20, !dbg !21

20:                                               ; preds = %23, %17
  %21 = phi i64 [ %26, %23 ], [ 0, %17 ]
  %22 = icmp ult i64 %21, 4, !dbg !22
...
31:                                               ; preds = %9
  %32 = insertvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %8, i64 4, 3, 2, !dbg !33
...
!3 = distinct !DISubprogram(name: "main_kernel_11", linkageName: "main_kernel_11", scope: null, file: !4, line: 2, type: !5, scopeLine: 2, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
!4 = !DIFile(filename: "1_kernels_llvmmlir/main_kernel_11_llvm.mlir", directory: "/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/ConvModel")
...
!15 = !DILocation(line: 26, column: 5, scope: !8)
...
!32 = !DILocation(line: 57, column: 5, scope: !8)
