; ModuleID = '/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/ConvModel/2_kernels_llvm/main_kernel_13.ll'
...
define void @main_kernel_13(ptr %0, ptr %1) !dbg !3 {
  ...
  %7 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %6, i64 4, 4, 0, !dbg !12
  ...
  %12 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %11, i64 4, 4, 0, !dbg !17
  br label %13, !dbg !18
...
16:                                               ; preds = %13
  %17 = mul nuw nsw i64 %14, 4
  br label %18, !dbg !21

18:                                               ; preds = %21, %16
  %19 = phi i64 [ %27, %21 ], [ 0, %16 ]
  %20 = icmp ult i64 %19, 4, !dbg !22
...
30:                                               ; preds = %13
  %31 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %7, i64 4, 3, 1, !dbg !34
  %32 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %12, i64 4, 3, 1, !dbg !35
...
!3 = distinct !DISubprogram(name: "main_kernel_13", linkageName: "main_kernel_13", scope: null, file: !4, line: 2, type: !5, scopeLine: 2, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
!4 = !DIFile(filename: "1_kernels_llvmmlir/main_kernel_13_llvm.mlir", directory: "/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/ConvModel")
...
!21 = !DILocation(line: 40, column: 5, scope: !8)
