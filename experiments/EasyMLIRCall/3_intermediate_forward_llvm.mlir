...
module attributes {torch.debug_module_name = "L"} {
  ...
  ^bb1:  // pred: ^bb0
    ...
    scf.for %arg3 = %c0 to %c10 step %c1 {
      %0 = memref.load %arg0[%arg3] : memref<10xf32>
      %1 = memref.load %arg1[%arg3] : memref<10xf32>
      %2 = arith.addf %0, %1 : f32
      memref.store %2, %arg2[%arg3] : memref<10xf32>
    }
    return
  }
}
...
module attributes {torch.debug_module_name = "L"} {
  ...
  ^bb3:  // pred: ^bb2
    ...
    %3 = memref.load %arg1[%0] : memref<10xf32>
    %4 = arith.addf %2, %3 : f32
    memref.store %4, %arg2[%0] : memref<10xf32>
...
module attributes {torch.debug_module_name = "L"} {
  ...
  ^bb3:  // pred: ^bb2
    %7 = memref.load %arg0[%4] : memref<10xf32>
    %8 = memref.load %arg1[%4] : memref<10xf32>
    %9 = llvm.fadd %7, %8  : f32
    memref.store %9, %arg2[%4] : memref<10xf32>
    %10 = llvm.add %5, %0  : i64
...
module attributes {torch.debug_module_name = "L"} {
  llvm.func @forward(%arg0: !llvm.ptr<f32>, %arg1: !llvm.ptr<f32>) -> !llvm.ptr<f32> {
    ...
    %18 = memref.alloc() {alignment = 64 : i64} : memref<10xf32>
    %19 = builtin.unrealized_conversion_cast %18 : memref<10xf32> to !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)>
    %20 = llvm.extractvalue %8[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)> 
    %21 = llvm.extractvalue %17[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)> 
    %22 = llvm.extractvalue %19[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @forward_kernel_0(%20, %21, %22) : (!llvm.ptr<f32>, !llvm.ptr<f32>, !llvm.ptr<f32>) -> ()
    %23 = llvm.extractvalue %19[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.return %23 : !llvm.ptr<f32>
  }
...
module attributes {llvm.data_layout = "", torch.debug_module_name = "L"} {
  ...
  llvm.func @forward(%arg0: !llvm.ptr<f32>, %arg1: !llvm.ptr<f32>) -> !llvm.ptr<f32> {
    ...
    %41 = builtin.unrealized_conversion_cast %40 : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)> to memref<10xf32>
    %42 = builtin.unrealized_conversion_cast %41 : memref<10xf32> to !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)>
    %43 = llvm.extractvalue %8[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)> 
    %44 = llvm.extractvalue %17[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)> 
    %45 = llvm.extractvalue %42[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @forward_kernel_0(%43, %44, %45) : (!llvm.ptr<f32>, !llvm.ptr<f32>, !llvm.ptr<f32>) -> ()
    %46 = llvm.extractvalue %42[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.return %46 : !llvm.ptr<f32>
  }
  llvm.func @forward_kernel_0(!llvm.ptr<f32>, !llvm.ptr<f32>, !llvm.ptr<f32>) attributes {Kernel, forward_kernel_0}
}
