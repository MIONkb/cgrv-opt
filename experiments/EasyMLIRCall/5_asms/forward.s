...
forward:                                # @forward
.Lfunc_begin0:
	.file	1 "/home/tianyi/fdra/app-compiler/cgra-opt/experiments/EasyMLIRCall" "3_forward_llvm.mlir"
	.loc	1 3 0                           # 3_forward_llvm.mlir:3:0
	.cfi_startproc
# %bb.0:
	addi	sp, sp, -32
...
.Ltmp0:
	...
	addi	a0, a0, 63
	.loc	1 36 11                         # 3_forward_llvm.mlir:36:11
	andi	s0, a0, -64
	.loc	1 46 5                          # 3_forward_llvm.mlir:46:5
	mv	a0, s1
	mv	a1, s2
	mv	a2, s0
	call	forward_kernel_0@plt
	.loc	1 48 5                          # 3_forward_llvm.mlir:48:5
	mv	a0, s0
