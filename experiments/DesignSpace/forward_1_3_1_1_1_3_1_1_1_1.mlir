...
module attributes {torch.debug_module_name = "L"} {
  ...
  func.func @forward(%arg0: memref<4x3xf32>) -> memref<4x3xf32> {
    ...
    affine.for %arg1 = 0 to 4 {
      affine.store %cst, %1[%arg1, %c0_0] : memref<4x3xf32>
      %3 = affine.apply #map0(%c0_0)
      affine.store %cst, %1[%arg1, %3] : memref<4x3xf32>
      %4 = affine.apply #map1(%c0_0)
    ...
    affine.for %arg1 = 0 to 4 {
      affine.for %arg2 = 0 to 3 {
        %3 = affine.load %arg0[%arg1, %c0] : memref<4x3xf32>
        %4 = affine.load %0[%c0, %arg2] : memref<3x3xf32>
        ...
        %9 = affine.load %arg0[%arg1, %8] : memref<4x3xf32>
        %10 = affine.load %0[%8, %arg2] : memref<3x3xf32>
        %11 = affine.load %2[%arg1, %arg2] : memref<4x3xf32>
        %12 = arith.mulf %9, %10 : f32
        %13 = arith.addf %11, %12 : f32
        affine.store %13, %2[%arg1, %arg2] : memref<4x3xf32>
        %14 = affine.apply #map1(%c0)
        %15 = affine.load %arg0[%arg1, %14] : memref<4x3xf32>
        %16 = affine.load %0[%14, %arg2] : memref<3x3xf32>
        %17 = affine.load %2[%arg1, %arg2] : memref<4x3xf32>
        %18 = arith.mulf %15, %16 : f32
        %19 = arith.addf %17, %18 : f32
        affine.store %19, %2[%arg1, %arg2] : memref<4x3xf32>
      }
    }
