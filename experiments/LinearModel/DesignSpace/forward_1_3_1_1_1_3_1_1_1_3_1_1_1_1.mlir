...
module attributes {torch.debug_module_name = "L"} {
  ...
  func.func @forward(%arg0: memref<4x3xf32>) -> memref<4x3xf32> {
    ...
    affine.for %arg1 = 0 to 3 {
      %5 = affine.load %0[%arg1, %c0_1] : memref<3x3xf32>
      affine.store %5, %1[%c0_1, %arg1] : memref<3x3xf32>
      %6 = affine.apply #map0(%c0_1)
      %7 = affine.load %0[%arg1, %6] : memref<3x3xf32>
      affine.store %7, %1[%6, %arg1] : memref<3x3xf32>
      %8 = affine.apply #map1(%c0_1)
    ...
    affine.for %arg1 = 0 to 4 {
      affine.store %cst, %2[%arg1, %c0_0] : memref<?x?xf32>
      %5 = affine.apply #map0(%c0_0)
      affine.store %cst, %2[%arg1, %5] : memref<?x?xf32>
      %6 = affine.apply #map1(%c0_0)
      affine.store %cst, %2[%arg1, %6] : memref<?x?xf32>
    }
