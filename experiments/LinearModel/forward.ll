...
@__constant_3x3xf32 = private constant [3 x [3 x float]] [[3 x float] [float 0x3FE235D5C0000000, float 0xBFDE4D2080000000, float 0x3FE09D5D20000000], [3 x float] [float 0xBFCDA589A0000000, float 0xBFB5EB6260000000, float 0x3FE278DB40000000], [3 x float] [float 0xBFB939A060000000, float 0xBF8D920940000000, float 0x3FD79B2DE0000000]]
...
define ptr @forward(ptr %0) !dbg !3 {
  ...
  %9 = alloca float, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 9) to i64), align 4, !dbg !15
  ...
  %18 = alloca float, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 12) to i64), align 4, !dbg !25
  ...
  %27 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 12) to i64), i64 64)), !dbg !35
  ...
  %36 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %35, i64 4, 3, 0, !dbg !44
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr %41, ptr %40, i64 mul (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 12), i1 false), !dbg !50
  %42 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %16, 1, !dbg !51
  %43 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %39, 1, !dbg !52
  call void @forward_kernel_2(ptr %0, ptr %42, ptr %43), !dbg !53
...
!4 = !DIFile(filename: "3_forward_llvm.mlir", directory: "/home/tianyi/MLIRCGRA/CGRA-Flow/mlir-cgra/experiments/LJHtest/LinearModel")
