...
24:                                               ; preds = %21
  ...
  %27 = getelementptr float, ptr @__constant_3x3xf32, i64 %26, !dbg !31
  %28 = load float, ptr %27, align 4, !dbg !32
  %29 = mul i64 %22, 3, !dbg !33
  %30 = add i64 %29, %18, !dbg !34
  %31 = getelementptr float, ptr %9, i64 %30, !dbg !35
  store float %28, ptr %31, align 4, !dbg !36
...
35:                                               ; preds = %17
  %36 = alloca float, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 6) to i64), align 4, !dbg !41
...
51:                                               ; preds = %48
  ...
  %54 = getelementptr float, ptr %36, i64 %53, !dbg !57
  store float 0.000000e+00, ptr %54, align 4, !dbg !58
...
58:                                               ; preds = %44
  %59 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 6) to i64), i64 64)), !dbg !63
  ...
  %72 = getelementptr float, ptr %36, i64 0, !dbg !76
  %73 = getelementptr float, ptr %64, i64 0, !dbg !77
  call void @llvm.memcpy.p0.p0.i64(ptr %73, ptr %72, i64 mul (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 6), i1 false), !dbg !78
