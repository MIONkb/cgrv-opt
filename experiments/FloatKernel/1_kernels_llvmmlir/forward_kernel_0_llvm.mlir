module attributes {llvm.data_layout = ""} {
  llvm.func @forward_kernel_0(%arg0: !llvm.ptr<f32>, %arg1: !llvm.ptr<f32>, %arg2: !llvm.ptr<f32>) attributes {Kernel, forward_kernel_0} {
  ...
  ^bb5:  // pred: ^bb4
    %47 = llvm.extractvalue %38[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<2 x i64>, array<2 x i64>)> 
    ...
    llvm.br ^bb6(%42, %52 : i64, f32)
  ^bb6(%53: i64, %54: f32):  // 2 preds: ^bb5, ^bb7
    %55 = llvm.icmp "slt" %53, %39 : i64
    llvm.cond_br %55, ^bb7, ^bb8
  ^bb7:  // pred: ^bb6
    %56 = llvm.extractvalue %12[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<2 x i64>, array<2 x i64>)> 
    ...
    %62 = llvm.extractvalue %25[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<2 x i64>, array<2 x i64>)> 
    ...
    %69 = llvm.fadd %54, %68  : f32
    %70 = llvm.add %53, %40  : i64
    llvm.br ^bb6(%70, %69 : i64, f32)
  ^bb8:  // pred: ^bb6
    %71 = llvm.extractvalue %38[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<2 x i64>, array<2 x i64>)> 
    %72 = llvm.mlir.constant(3 : index) : i64
    %73 = llvm.mul %43, %72  : i64
    %74 = llvm.add %73, %45  : i64
    %75 = llvm.getelementptr %71[%74] : (!llvm.ptr<f32>, i64) -> !llvm.ptr<f32>
    llvm.store %54, %75 : !llvm.ptr<f32>
