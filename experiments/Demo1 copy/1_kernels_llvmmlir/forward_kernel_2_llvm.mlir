module attributes {llvm.data_layout = ""} {
  llvm.func @forward_kernel_2(%arg0: !llvm.ptr<f32>, %arg1: !llvm.ptr<f32>, %arg2: !llvm.ptr<f32>) attributes {Kernel, forward_kernel_2} {
    ...
    %40 = llvm.mlir.constant(12 : index) : i64
  ...
  ^bb7:  // pred: ^bb6
    ...
    %63 = llvm.mlir.constant(12 : index) : i64
